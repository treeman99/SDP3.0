...
export const matrixData: MatrixRow[] = [
  ...
  { index: '1.1.2',   title: 'Expectation ABCD',                    progress: '40', updated: '2025-06-08', support: 'Accepted', apsElectric: '이삼성',       apsOptic: '이삼성외 1명',  analog: '이삼성',       digitalChip: '이삼성',       fw: '-',            alpdp: '이삼성',       pm: '이삼성외 1명' },
  { index: '1.1.2.1', title: 'Expectation BCDEF',                   progress: '40', updated: '2025-06-08', support: 'Accepted', apsElectric: '-',            apsOptic: '-',            analog: '이삼성',       digitalChip: '이삼성외 1명',  fw: '-',            alpdp: '-',            pm: '이삼성' },
  ...
  { index: '2.2.1',   title: 'Expectation BCDEF',                   progress: '40', updated: '2025-06-08', support: 'Accepted', apsElectric: '이삼성외 1명',  apsOptic: '-',            analog: '이삼성',       digitalChip: '이삼성',       fw: '이삼성외 1명', alpdp: '이삼성',       pm: '이삼성' },
  ...
  { index: '2.3',     title: 'Expectation ABCEFG Expecticn',        progress: '40', updated: '2025-06-08', support: 'Accepted', apsElectric: '-',            apsOptic: '이삼성',       analog: '-',            digitalChip: '이삼성외 1명',  fw: '이삼성',       alpdp: '이삼성',       pm: '이삼성' },
  ...
  { index: '3.1',     title: 'Expectation ABCEF, Production W123',  progress: '',   updated: '2025-06-08', support: 'Rejected', apsElectric: '-',            apsOptic: '이삼성',       analog: '이삼성외 1명',  digitalChip: '이삼성외 1명',  fw: '이삼성',       alpdp: '이삼성',       pm: '이삼성' },
