...
export const assignedErsData: AssignedErsRow[] = [
...
export const assignedFunctionData: AssignedFunctionRow[] = [
...
export const ersSummary = { total: 24, inProgress: 12, inApproval: 1, done: 11 }
